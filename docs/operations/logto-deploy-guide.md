...
> 💡 SPA 하위 프레임워크 프리셋(Angular/React/Vue/...)에 Flutter는 없습니다 — 프리셋은 튜토리얼용이고 앱 동작엔 무관합니다. Flutter Web은 **Logto Flutter SDK(`logto_dart_sdk`)** 로 통합하므로 **Vanilla JS**를 고르면 됩니다.
1. **Create Application** → **Single Page App** → 프레셋 **Vanilla JS**
2. Name: `LALA Web`
