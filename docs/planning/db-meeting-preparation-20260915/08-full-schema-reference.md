...
기준 `765570a21ff5ab5207c627d3659e8051be6dbd98`의 canonical SQL 18개를 누적 해석하였다. **53개 테이블·471개 컬럼·49개 FK·7개 뷰**다. 현재 main `41468b01`에 추가된 SQL 069~071은 이 참고표에 아직 반영하지 않았다. DEFAULT·CHECK는 코드 정의이며 실제 DB의 전체 표현식 동등성 검증을 뜻하지 않는다. 업무 해설은 [핵심 데이터 사전](03-data-dictionary.md)을 함께 본다.
