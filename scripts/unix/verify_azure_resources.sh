...
SUBSCRIPTION_ID="${LALA_AZURE_SUBSCRIPTION_ID:-00000000-0000-0000-0000-000000000000}"
RESOURCE_GROUP="${LALA_AZURE_RESOURCE_GROUP:-lala-resource-group}"
KEY_VAULT_NAME="${LALA_KEY_VAULT_NAME:-lala-key-vault}"
OPENAI_ACCOUNT_NAME="${LALA_AZURE_OPENAI_ACCOUNT_NAME:-lala-openai-account}"
OPENAI_DEPLOYMENT_NAME="gpt-4o-mini"
SPEECH_ACCOUNT_NAME="${LALA_AZURE_SPEECH_ACCOUNT_NAME:-lala-speech-account}"
ONMU_VAULT_NAME="${ONMU_KEY_VAULT_NAME:-onmu-source-vault}"
PYTHON_ARG=""
